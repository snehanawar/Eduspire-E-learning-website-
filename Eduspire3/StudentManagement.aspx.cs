...
namespace Eduspire3
{
    public partial class StudentManagement : System.Web.UI.Page
    {
        ...
        private void LoadRecord()
        {
            ...
            SqlCommand comm = new SqlCommand("Select * from RegisterStu_Table5", con);
        ...
        private Boolean CheckFNameInRegister()
        {
            Boolean FName = false;
            SqlConnection con = new SqlConnection(mycon);
            String query = "Select * from RegisterStu_Table5 where stu_FirstName='" + txtFName.Text + "'";
            SqlCommand com = new SqlCommand(query, con);
            SqlDataAdapter da = new SqlDataAdapter();
            da.SelectCommand = com;
            DataSet ds = new DataSet();
        ...
        private Boolean CheckLNameInRegister()
        {
            Boolean LName = false;
            SqlConnection con = new SqlConnection(mycon);
            String query = "Select * from RegisterStu_Table5 where stu_LastName='" + txtLName.Text + "'";
            SqlCommand com = new SqlCommand(query, con);
            SqlDataAdapter da = new SqlDataAdapter();
            da.SelectCommand = com;
            DataSet ds = new DataSet();
        ...
        private Boolean CheckContactInRegister()
        {
            ...
            SqlConnection con = new SqlConnection(mycon);
            String query = "Select * from RegisterStu_Table5 where stu_ContactNo='" + txtContactNo.Text + "'";
            SqlCommand com = new SqlCommand(query, con);
            SqlDataAdapter da = new SqlDataAdapter();
            da.SelectCommand = com;
            DataSet ds = new DataSet();
        ...
        protected void btnSearch_Click1(object sender, EventArgs e)
        {
            ...
            if (txtEmailID.Text != "")
            {
                ...
                else
                {
                    ...
                    txtContactNo.Text = "";
                    SqlConnection con = new SqlConnection(mycon);
                    SqlCommand comm = new SqlCommand("Select * from RegisterStu_Table5 where stu_EmailID='" + txtEmailID.Text + "'", con);
                    SqlDataAdapter d = new SqlDataAdapter(comm);
                    DataTable dt = new DataTable();
                    d.Fill(dt);
                    GridView1.DataSource = dt;
            ...
            if (txtFName.Text != "")
            {
                ...
                else
                {
                    ...
                    txtContactNo.Text = "";
                    SqlConnection con = new SqlConnection(mycon);
                    SqlCommand comm = new SqlCommand("Select * from RegisterStu_Table5 where stu_FirstName='" + txtFName.Text + "'", con);
                    SqlDataAdapter d = new SqlDataAdapter(comm);
                    DataTable dt = new DataTable();
                    d.Fill(dt);
                    GridView1.DataSource = dt;
            ...
            if (txtLName.Text != "")
            {
                ...
                else
                {
                    ...
                    txtContactNo.Text = "";
                    SqlConnection con = new SqlConnection(mycon);
                    SqlCommand comm = new SqlCommand("Select * from RegisterStu_Table5 where stu_LastName='" + txtLName.Text + "'", con);
                    SqlDataAdapter d = new SqlDataAdapter(comm);
                    DataTable dt = new DataTable();
                    d.Fill(dt);
                    GridView1.DataSource = dt;
            ...
            if (txtContactNo.Text != "")
            {
                ...
                else
                {
                    ...
                    txtLName.Text = "";
                    SqlConnection con = new SqlConnection(mycon);
                    SqlCommand comm = new SqlCommand("Select * from RegisterStu_Table5 where stu_ContactNo='" + txtContactNo.Text + "'", con);
                    SqlDataAdapter d = new SqlDataAdapter(comm);
                    DataTable dt = new DataTable();
                    d.Fill(dt);
                    GridView1.DataSource = dt;
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (txtEmailID.Text != "")
            {
                ...
                else
                {
                    ...
                    SqlConnection con = new SqlConnection(mycon);
                    con.Open();
                    SqlCommand comm = new SqlCommand("update RegisterStu_Table5 set stu_EmailID='" + txtEmailID.Text + "' where stu_ID='" + int.Parse(lblID.Text) + "' ", con);
            ...
            if (txtFName.Text != "")
            {
                ...
                else
                {
                    ...
                    SqlConnection con = new SqlConnection(mycon);
                    con.Open();
                    SqlCommand comm = new SqlCommand("update RegisterStu_Table5 set stu_FirstName='" + txtFName.Text + "' where stu_ID='" + int.Parse(lblID.Text) + "' ", con);
                    comm.ExecuteNonQuery();
                    con.Close();
                    //Response.Write("<script>alert('Successfully Updated!')</script>");
                    LoadRecord();
            ...
            if (txtLName.Text != "")
            {
                ...
                else
                {
                    ...
                    SqlConnection con = new SqlConnection(mycon);
                    con.Open();
                    SqlCommand comm = new SqlCommand("update RegisterStu_Table5 set stu_LastName='" + txtLName.Text + "' where stu_ID='" + int.Parse(lblID.Text) + "' ", con);
                    comm.ExecuteNonQuery();
                    con.Close();
                    //Response.Write("<script>alert('Successfully Updated!')</script>");
                    LoadRecord();
            ...
            if (txtContactNo.Text != "")
            {
                ...
                else
                {
                    ...
                    SqlConnection con = new SqlConnection(mycon);
                    con.Open();
                    SqlCommand comm = new SqlCommand("update RegisterStu_Table5 set stu_ContactNo='" + txtContactNo.Text + "' where stu_ID='" + int.Parse(lblID.Text) + "' ", con);
                    comm.ExecuteNonQuery();
                    con.Close();
                    //Response.Write("<script>alert('Successfully Updated!')</script>");
                    LoadRecord();
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                lblEmailError.Text = "Enter numbers only";
            }
            else if (CheckEmailInRegister() == false)
            {
                lblEmailError.Text = "Entered ID doesn't exist";
            }
            else
            {
                lblEmailError.Text = "";
                SqlConnection con = new SqlConnection(mycon);
                con.Open();
                SqlCommand comm = new SqlCommand("delete RegisterStu_Table5 where stu_EmailID='" + txtEmailID.Text + "' ", con);
                comm.ExecuteNonQuery();
                con.Close();
