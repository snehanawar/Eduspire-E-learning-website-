<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginAsTutor7.aspx.cs" Inherits="Eduspire3.LoginAsTutor7" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Eduspire | Login as Tutor</title>
</head>
<body>
        ...
        <div class="row">
            <div class="col-md-1"></div>
                <div class="col-md-8 login-sec">
                    <h2 class="text-center" style="  margin-top: 42px;"> Welcome back to Eduspire!</h2>
                    <form class="login-form" runat="server">
                        ...
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/ForgotPassForTut.aspx">Forgot Password?</asp:HyperLink>
                    ...
                    <div class=" form-control-plaintext">
                            ...
                            &nbsp;<asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/VerifyTutor3.aspx">Apply</asp:HyperLink>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
