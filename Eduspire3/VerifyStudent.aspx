<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerifyStudent.aspx.cs" Inherits="Eduspire3.VerifyStudent" %>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 login-sec">
                        ...
                        <div class="d-flex justify-content-end pt-3" id="div_VerifyOtp" runat="server">
                            <asp:Button ID="btnVerify" runat="server" ValidationGroup="OTP" Text="Verify" BackColor="#FF6666" Font-Bold="False" Font-Size="Large" ForeColor="White" Height="32px" Width="105px" BorderWidth="1px" onmouseover="this.style.fontWeight='bold'" onmouseout="this.style.fontWeight='normal'" OnClick="btnVerify_Click"  />
                            </div>


                        <div class="copy-text" style="margin-left: 40px">
                            <a href="HomePage.aspx">Home</a> / <a href="Login6.aspx">Login</a> / <a href="VerifyTutor3.aspx">Tutor Application</a>
