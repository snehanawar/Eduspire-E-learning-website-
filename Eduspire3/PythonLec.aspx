<%@ Page Title="" Language="C#" MasterPageFile="~/ContentStu.Master" AutoEventWireup="true" CodeBehind="PythonLec.aspx.cs" Inherits="Eduspire3.PythonLec" %>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-xl-12 login-sec">
                                    <div class="card-body p-md-3 text-black">
                                        <h2 style="margin-top: -56px;" class="text-center">Python Lectures</h2>
